...
int main(){
    ...
    for(int i = 0; i < filesNum; i++){
        ...
        contactIn.open(inFileName);

        std::getline(contactIn, tempStr);
    ...
    cout << contactsNumArr[0];
    cout << contactsNumArr[1];
    cout << contactsNum;
    OutSortedList outList(contactsNum);
    outList.GetFileContacts("contacts1.dat", contactsNumArr, 0);
    outList.GetFileContacts("contacts2.dat", contactsNumArr, 1);
    outList.Reset();
    cout << outList;
    //outList.Test();
}